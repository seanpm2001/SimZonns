...
// This is the Legacy Mode Verizon virtual machine for the SimZonns Android app. It is designed to work and emulate Verizon and its service level.
...
public class FibCalculator extends Fibonacci implements Calculator {
    ...
    public static int appMain(int appIndex) {
      System.out.println("Welcome to the SimZonns Android app for Verizon (running in Legacy Mode)");
...
* File version: 1 (Tuesday, June 15th 2021 at 6:27 pm)
