...
public class MyCRC
{
  ...
  public static class Parameters
  {
    ...
    public void setPolynomial(final long polynomial) {
      this.polynomial = polynomial;
    }
    ...
    public void setFinalXor(final long finalXor) {
      this.finalXor = finalXor;
    }
   ...
   */
  public static long reflect(long in, int count)
  {
    long ret = in;
   ...
   * @param  crcParams CRC algorithm parameters
   */
  public MyCRC(Parameters crcParams)
  {
